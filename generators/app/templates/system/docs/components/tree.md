      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            ...
            <span>
              <sm-button size="mini" type="text" on-click={ () => this.append(data) }>Append</sm-button>
              <sm-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</sm-button>
            </span>
          </span>);
      },
...
:::demo
```html
<sm-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></sm-tree>
...
<div class="buttons">
  <sm-button @click="getCheckedNodes">get by node</sm-button>
  <sm-button @click="getCheckedKeys">get by key</sm-button>
  <sm-button @click="setCheckedNodes">set by node</sm-button>
  <sm-button @click="setCheckedKeys">set by key</sm-button>
  <sm-button @click="resetChecked">reset</sm-button>
</div>
