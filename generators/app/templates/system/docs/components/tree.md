      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            ...
            <span>
              <<%= sysAbb %>-button size="mini" type="text" on-click={ () => this.append(data) }>Append</<%= sysAbb %>-button>
              <<%= sysAbb %>-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</<%= sysAbb %>-button>
            </span>
          </span>);
      },
...
:::demo
```html
<<%= sysAbb %>-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></<%= sysAbb %>-tree>
...
<div class="buttons">
  <<%= sysAbb %>-button @click="getCheckedNodes">get by node</<%= sysAbb %>-button>
  <<%= sysAbb %>-button @click="getCheckedKeys">get by key</<%= sysAbb %>-button>
  <<%= sysAbb %>-button @click="setCheckedNodes">set by node</<%= sysAbb %>-button>
  <<%= sysAbb %>-button @click="setCheckedKeys">set by key</<%= sysAbb %>-button>
  <<%= sysAbb %>-button @click="resetChecked">reset</<%= sysAbb %>-button>
</div>
